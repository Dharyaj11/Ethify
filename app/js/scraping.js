...
//   if (document.getElementById("ethify_count")) {
//     return;
//   }

//   // aggregate all DOM elements on the page
//   let elements = segmented(document.body);
...
//   element.classList.add("ethify-underline");

//   let body = document.createElement("span");
//   body.classList.add("ethify-underline-body");
...
//     let element = document.getElementById("ethify_count");
//     if (element) {
...
function scrape(filterCategory = 'all') {
  // website has already been analyzed
  if (document.getElementById("ethify_count")) {
    return;
  }
  ...
  fetch(endpoint, {
    ...
    .then((data) => {
      ...
      for (let i = 0; i < elements.length; i++) {
        ...
        if (json.recon[i] !== "Not Dark" && (filterCategory === 'all' || filterCategory === json.recon[i])) {
          highlight(elements[element_index], json.recon[i]);
          dp_count++;
        }
        element_index++;
      }
...
function highlight(element, type) {
  element.classList.add("ethify-highlight");

  let body = document.createElement("span");
  body.classList.add("ethify-highlight-body");
